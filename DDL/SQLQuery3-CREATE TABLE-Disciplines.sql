...
---- RD - RquiredDisciplines ( имя таблицы в которой сейчас нахлдимся );
----discipline - имя поля которое является внешним ключом;
----2Disciplines - Показывает на какую таблицу ссылается внешний ключ; 
--);
